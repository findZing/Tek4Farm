...
const Post = () => {
  ...
  return (
    <div className="w-[250px] border border-black rounded-[10px] flex flex-col items-center gap-[10px] px-[10px] py-[10px] relative z-10">
      ...
      <div className="w-[30px] h-[30px] bg-white rounded-[10px] shadow-sm flex items-center justify-center absolute top-[10px] right-[10px]">
        {
        clickHeart ? 
